...
//
//		assertFalse(contains(null, 50001));
//		assertFalse(contains(null, -50001));
//
...
//		assertEquals(0, len(remove(null, 8)));
//		assertEquals(0, len(remove(EMPTY, 8)));
//
//		assertArrayEquals(iNo8, remove(i, Objs.toArray("8"), j->""+j));
//		assertArrayEquals(i, remove(i, Objs.toArray("-8"), j->""+j));
//		assertEquals(0, len(remove(null, Objs.toArray("8"), j->""+j)));
//		assertEquals(0, len(remove(EMPTY, Objs.toArray("8"), j->""+j)));
//
...
//		assertEquals(0, len(remove(null, toArray(8, 100102))));
//		assertEquals(0, len(remove(EMPTY, toArray(8, 100102))));
//
...
//		assertEquals(0, foldl(null, 0, (k, j)->k+j));
//
...
//		assertArrayEquals(EMPTY, pair(null, (k, j)->k+j));
//	}
//
//	@Test
...
//		assertArrayEquals(EMPTY, pairLeft(null, 7, (k, j)->k+j));
//	}
//
//	@Test
...
//
//		assertEquals(0, len(filter(null, j->j!=8)));
//		assertEquals(0, len(filter(EMPTY, j->j!=8)));
//	}
//
//	@Test
...
//		assertEquals(0, len(reversed(EMPTY)));
//		assertEquals(0, len(reversed(null)));
//	}
//	
//	@Test
...
//		
//		assertArrayEquals(j, append(null, j));
//		assertArrayEquals(j, append(EMPTY, j));
//		assertArrayEquals(toArray(8), append(null, 8));
