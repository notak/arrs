...
public class JsonWriterTest {
	...
	public void testQuickJsonArray() {
		assertEquals("[1,2,3]", JsonWriter.string(toArray(1, 2, 3)));
	}

	@Test
	public void testQuickArray() {
		assertEquals("[1,2,3]", JsonWriter.string(asList(1, 2, 3)));
	}

	@Test
	public void testQuickArrayEmpty() {
		assertEquals("[]", JsonWriter.string(emptyList()));
	}
