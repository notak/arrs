...
/** Common interface for {@link JsonAppendableWriter}, {@link JsonStringWriter} 
 * and {@link JsonBuilder}.
 * 
...
public interface JsonSink<SELF extends JsonSink<SELF>> {
	...
	/** Emits an object if it is a JSON-compatible type, otherwise throw */
	SELF value(Object o);

	/** Emits an object plus key if it is a JSON-compatible type, otherwise throw */
